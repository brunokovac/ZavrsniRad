...
def test(test_data, test_labels):
	...
	with tf.Session() as sess:
		...
		np.savetxt("drive/zavrsni/test_labels_original.txt", test_labels)
		np.savetxt("drive/zavrsni/softmax_matrix_original.txt", sess.run(logits, feed_dict = {X : test_data, Y_ : test_labels}))
