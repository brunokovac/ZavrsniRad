...
def test(test_data, test_labels):
	...
	with tf.Session() as sess:
		...
		np.savetxt("drive/zavrsni/test_labels_gaussian.txt", test_labels)
		np.savetxt("drive/zavrsni/softmax_matrix_gaussian.txt", softmax_matrix)
...
if __name__ == "__main__":
	...
	test_data = test_data + np.random.normal(scale=0.5, size=test_data.shape).astype("float32")
